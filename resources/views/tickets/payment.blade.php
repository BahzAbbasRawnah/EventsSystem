...
<div class="container py-5">
    <div class="row">
        <!-- Order Summary -->
        <div class="col-md-6">
            <h2 class="text-dark fw-bold mb-4">{{ __('pages.summary') }}</h2>
        ...
        <!-- Payment Details -->
        <div class="col-md-6">
            <h2 class="text-dark fw-bold mb-4">{{ __('pages.details') }}</h2>
            ...
            <form method="POST" action="{{ route('tickets.payment') }}">
                ...
                <!-- Cardholder Name -->
                <div class="mb-3">
                    <label for="card-name" class="form-label text-dark">{{ __('pages.cardholder_name') }}</label>
                    <input type="text" name="card_name" class="form-control" id="card-name" placeholder="{{ __('pages.enter_card_name') }}" required>
                </div>

                <!-- Payment Method -->
                <div class="mb-3">
                    <label class="form-label text-dark">{{ __('pages.method') }}</label>
                    <div class="row g-2">
                ...
                <!-- Card Number -->
                <div class="mb-3">
                    <label for="card-number" class="form-label text-dark">{{ __('pages.card_number') }}</label>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        <label for="expiry-date" class="form-label text-dark">{{ __('pages.expiry_date') }}</label>
                        <input type="text" name="expiry_date" class="form-control" id="expiry-date" placeholder="{{ __('pages.expiry_placeholder') }}" required>
                    </div>

                    <!-- CVV -->
                    <div class="col-md-6 mb-3">
                        <label for="cvv" class="form-label text-dark">{{ __('pages.cvv') }}</label>
